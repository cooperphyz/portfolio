                ...
                <div className="project1-display">
                    <Fade left delay={200}>
                        <LeftSliceContent
                            ...
                            codelink={'https://github.com/osu-cascades/bda-explorer'}
                ...
                <div className="project2-display">
                    <Fade left delay={200}>
                        <LeftSliceContent
                            ...
                            languages={['React.js', 'HTML', 'Firebase', 'Shopify', 'CSS', 'JavaScript']}
                ...
                <div className="project3-display">
                    <Fade left delay={200}>
                        <LeftSliceContent
                            ...
                            codelink={'https://github.com/cooperphyz/CoffeeShopProject'}
                            livelink={' '}
